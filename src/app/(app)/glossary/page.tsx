...
const GLOSSARY = [
  {
    term: "Risk Score",
    def: "A 0–100% model-based defect risk estimate generated by our trained XGBoost Machine Learning model based on genuine static code complexity and Halstead metrics.",
  },
  {
  ...
  {
    term: "Predicted Defect Risk",
    def: "The model-based risk score float (0.0 to 1.0) output by the XGBoost classifier from static code metrics, used for decision support.",
  },
];
